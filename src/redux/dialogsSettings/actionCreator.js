...
export const fetchDialogsSettingsRequest = (id) => ({type: FETCH_DIALOGS_SETTINGS_REQUEST, id})
...
export const updatePhrasesRequest = (phrases, id) => ({type: UPDATE_PHRASES_REQUEST, payload: {phrases, id}})
...
export const updateGreetingRequest = (greeting, id) => ({type: UPDATE_GREETING_REQUEST, payload: {greeting, id}})
